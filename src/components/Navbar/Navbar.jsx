    ...
    <nav className="navbar navbar-expand-md navbar-light bg-main-light fixed-top">
      <div className="container">
        ...
        <li className="nav-item pt-2">
          <Link to=""><i class="fa-brands me-3 text-black fa-instagram"></i></Link>
          <Link to=""><i class="fa-brands me-3 text-black fa-facebook"></i></Link>
          <Link to=""><i class="fa-brands me-3 text-black fa-tiktok"></i></Link>
          <Link to=""><i class="fa-brands me-3 text-black fa-twitter"></i></Link>
          <Link to=""><i class="fa-brands me-3 text-black fa-linkedin "></i></Link>
          <Link to=""><i class="fa-brands me-3 text-black fa-youtube"></i></Link>
        </li>
                <li className="nav-item">
                  <NavLink
